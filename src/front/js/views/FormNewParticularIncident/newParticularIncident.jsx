...
import "./newParticularIncident.css";
import { Link } from "react-router-dom";
import { Redirect } from "react-router-dom";

const FormNewParticularIncident = () => {
  ...
  return (
    <div className="container-fluid m-auto mt-5 content">
      ...
      {redirect ? <Redirect to="/incidencias/particulares"></Redirect> : null}
    </div>
  );
};

export default FormNewParticularIncident;
